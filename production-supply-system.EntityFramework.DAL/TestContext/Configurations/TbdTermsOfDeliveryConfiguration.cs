...
{
    public partial class TbdTermsOfDeliveryConfiguration : IEntityTypeConfiguration<TbdTermsOfDelivery>
    {
        public void Configure(EntityTypeBuilder<TbdTermsOfDelivery> entity)
        {
            entity.HasKey(e => e.DeliveryTermsId).HasName("PK_tbd_Delivery_Terms");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<TbdTermsOfDelivery> entity);
    }
}
