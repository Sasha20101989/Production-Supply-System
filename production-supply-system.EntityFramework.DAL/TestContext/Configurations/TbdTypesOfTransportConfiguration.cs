...
{
    public partial class TbdTypesOfTransportConfiguration : IEntityTypeConfiguration<TbdTypesOfTransport>
    {
        public void Configure(EntityTypeBuilder<TbdTypesOfTransport> entity)
        {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<TbdTypesOfTransport> entity);
    }
}
