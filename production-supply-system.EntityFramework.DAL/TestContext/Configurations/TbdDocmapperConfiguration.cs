...
{
    public partial class TbdDocmapperConfiguration : IEntityTypeConfiguration<TbdDocmapper>
    {
        public void Configure(EntityTypeBuilder<TbdDocmapper> entity)
        {
            entity.Property(e => e.FirstDataRow).HasDefaultValue(1);
            entity.Property(e => e.IsActive).HasDefaultValue(true);

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<TbdDocmapper> entity);
    }
}
