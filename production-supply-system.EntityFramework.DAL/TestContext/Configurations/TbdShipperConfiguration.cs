...
{
    public partial class TbdShipperConfiguration : IEntityTypeConfiguration<TbdShipper>
    {
        public void Configure(EntityTypeBuilder<TbdShipper> entity)
        {
            entity.HasOne(d => d.ShipperDefaultDeliveryLocation).WithMany(p => p.TbdShippers).HasConstraintName("FK_tbd_Shippers_tbd_Locations");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<TbdShipper> entity);
    }
}
