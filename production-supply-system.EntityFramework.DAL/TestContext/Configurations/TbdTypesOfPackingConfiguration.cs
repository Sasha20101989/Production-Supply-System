...
{
    public partial class TbdTypesOfPackingConfiguration : IEntityTypeConfiguration<TbdTypesOfPacking>
    {
        public void Configure(EntityTypeBuilder<TbdTypesOfPacking> entity)
        {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<TbdTypesOfPacking> entity);
    }
}
