...
{
    public partial class TbdSectionConfiguration : IEntityTypeConfiguration<TbdSection>
    {
        public void Configure(EntityTypeBuilder<TbdSection> entity)
        {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<TbdSection> entity);
    }
}
