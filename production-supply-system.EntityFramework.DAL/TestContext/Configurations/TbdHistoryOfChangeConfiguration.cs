...
{
    public partial class TbdHistoryOfChangeConfiguration : IEntityTypeConfiguration<TbdHistoryOfChange>
    {
        public void Configure(EntityTypeBuilder<TbdHistoryOfChange> entity)
        {
            entity.HasKey(e => e.Id).HasName("PK_tbd_HistoryOfChanges");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<TbdHistoryOfChange> entity);
    }
}
